...
VALUES ('20251028114736_InitialCreate', '9.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20251103203502_addIdentity', '9.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20251104163957_AddObstacleStatusTracking', '9.0.10');

ALTER TABLE `Obstacles` ADD `ObstacleType` varchar(50) CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20251111112117_AddObstacleTypeColumn', '9.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20251124120017_RemoveRegisterforerRole', '9.0.10');

ALTER TABLE `Obstacles` ADD `Organization` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20251201112223_AddOrganizationToObstacle', '9.0.10');
